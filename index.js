...
bot.on("message", async message => {
  ...
  if(!message.member.roles.find(r => r.name === "Scrim Staff")) return message.reply("No perms.");
  ...
  .addField("Top 5", [
    ...
    `<@${sortable[2][1]}> - ${sortable [2][3]} wins`,
    `<@${sortable[3][2]}> - ${sortable [3][4]} wins`,
     `<@${sortable[4][3]}> - ${sortable [4][5]} wins`
